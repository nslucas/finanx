...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Expense expense2 = new Expense(null, 200.0, "Jantar de aniversário de namoro", 1, sdf.parse("07/07/2023"), "jantar especial com meu namorado", tais.getId());
        Expense expense3 = new Expense(null, 70000.0, "Focus 2018 turbão!", 1, sdf.parse("25/05/2023"), "carro de playboy!!!", rodrigo.getId());
